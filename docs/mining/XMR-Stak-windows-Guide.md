...
If you want to change that, you will need to [compile yourself XMR-stak for Windows](https://github.com/Algersoft/xmr-stak/blob/master/doc/compile_Windows.md) and edit [donate-level.hpp](https://github.com/Algersoft/xmr-stak/blob/master/xmrstak/donate-level.hpp) before you build the binaries.
...
1. Download and install [XMR-Stak Unified Miner](https://github.com/Algersoft/xmr-stak/releases/latest). It will auto-detect your hardware, and tune everything for you.
2. Make a folder called `Kriegerrand Miner` on your Desktop and unzip the files you just downloaded for XMR-Stak in there.
3. Double-click on `xmr-stak.exe`.
    ...
    - Type `cd Desktop\Kriegerrand Miner`
