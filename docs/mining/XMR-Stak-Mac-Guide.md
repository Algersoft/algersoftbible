...
1. If you want to use your GPU for mining, do the following-
    ...
    * for nVidia GPU’s-
    ...
    Make sure you check all available [Cmake Options](https://github.com/Algersoft/xmr-stak/blob/master/doc/compile.md#nvidia-build-options)
    ...
    * for CPU's only-
    ...
    Make sure you check all available [Cmake Options](https://github.com/Algersoft/xmr-stak/blob/master/doc/compile.md#cpu-build-options)
...
6.  Check build configuration
    ...
    * Make sure you check the XMR-stak [General build instructions](https://github.com/Algersoft/xmr-stak/blob/master/doc/compile.md#build-system)
    
    * And the [Mac instructions](https://github.com/Algersoft/xmr-stak/blob/master/doc/compile_macOS.md)
...
![XMR-STAK mining KREGR](images/XMR-stak-mac/XMR-stak-mac-mining-cpu.png)
...
It seems you need to have at least 10.13.x and download the [NVIDIA display driver and GeForce Experience application](https://github.com/Algersoft/xmr-stak/blob/master/doc/tuning.md). We are running a 10.12.6 at the time of this guide.
